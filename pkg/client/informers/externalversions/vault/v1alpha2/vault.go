...
import (
	...
	versioned "github.com/bank-vaults/vault-operator/v2/pkg/client/clientset/versioned"
	internalinterfaces "github.com/bank-vaults/vault-operator/v2/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha2 "github.com/bank-vaults/vault-operator/v2/pkg/client/listers/vault/v1alpha2"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.VaultV1alpha2().Vaults(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.VaultV1alpha2().Vaults(namespace).Watch(context.TODO(), options)
			},
		},
		&vaultv1alpha2.Vault{},
		resyncPeriod,
...
func (f *vaultInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&vaultv1alpha2.Vault{}, f.defaultInformer)
}

func (f *vaultInformer) Lister() v1alpha2.VaultLister {
	return v1alpha2.NewVaultLister(f.Informer().GetIndexer())
}
