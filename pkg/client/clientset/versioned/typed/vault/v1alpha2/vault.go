...
type VaultInterface interface {
	Create(ctx context.Context, vault *v1alpha2.Vault, opts v1.CreateOptions) (*v1alpha2.Vault, error)
	Update(ctx context.Context, vault *v1alpha2.Vault, opts v1.UpdateOptions) (*v1alpha2.Vault, error)
	Delete(ctx context.Context, name string, opts v1.DeleteOptions) error
	DeleteCollection(ctx context.Context, opts v1.DeleteOptions, listOpts v1.ListOptions) error
	Get(ctx context.Context, name string, opts v1.GetOptions) (*v1alpha2.Vault, error)
	List(ctx context.Context, opts v1.ListOptions) (*v1alpha2.VaultList, error)
	Watch(ctx context.Context, opts v1.ListOptions) (watch.Interface, error)
	Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Vault, err error)
	Apply(ctx context.Context, vault *vaultv1alpha2.VaultApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.Vault, err error)
	VaultExpansion
}
...
func newVaults(c *VaultV1alpha2Client, namespace string) *vaults {
	return &vaults{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *vaults) Get(ctx context.Context, name string, options v1.GetOptions) (result *v1alpha2.Vault, err error) {
	result = &v1alpha2.Vault{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vaults").
		Name(name).
...
func (c *vaults) List(ctx context.Context, opts v1.ListOptions) (result *v1alpha2.VaultList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1alpha2.VaultList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("vaults").
...
func (c *vaults) Create(ctx context.Context, vault *v1alpha2.Vault, opts v1.CreateOptions) (result *v1alpha2.Vault, err error) {
	result = &v1alpha2.Vault{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("vaults").
...
func (c *vaults) Update(ctx context.Context, vault *v1alpha2.Vault, opts v1.UpdateOptions) (result *v1alpha2.Vault, err error) {
	result = &v1alpha2.Vault{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("vaults").
...
func (c *vaults) Patch(ctx context.Context, name string, pt types.PatchType, data []byte, opts v1.PatchOptions, subresources ...string) (result *v1alpha2.Vault, err error) {
	result = &v1alpha2.Vault{}
...
func (c *vaults) Apply(ctx context.Context, vault *vaultv1alpha2.VaultApplyConfiguration, opts v1.ApplyOptions) (result *v1alpha2.Vault, err error) {
	if vault == nil {
