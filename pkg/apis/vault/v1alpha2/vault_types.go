...
type VaultSpec struct {
	...
	// CredentialsConfig defines an external Secret for Vault and how it should be mounted to the Vault Pod
	...
	// Tolerations are Kubernetes Tolerations definition that should be applied to all Vault Pods.
	// default:
	...
	// IstioEnabled describes if the cluster has an Istio running and enabled.
	// default: false
...
// HSMDaemonNeeded returns if the unsealing mechanims needs an HSM Daemon present
