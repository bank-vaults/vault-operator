...
| --- | ---- | ------- | ----------- |
| `crds` | object | See [values.yaml](values.yaml) | If set, install CRDs through helm chart. |
...
| `bankVaults.image.tag` | string | `"v1.32.1"` | Bank-Vaults image tag (pinned to supported Bank-Vaults version). |
